 ...
 */
public class CustomCircleNetworkImageView extends ImageView {
    ...
    public CustomCircleNetworkImageView(Context context) {
        this(context, null);
    }

    public CustomCircleNetworkImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomCircleNetworkImageView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@link CustomCircleNetworkImageView#setDefaultImageResId(int)} on the view.
     * <p>
     * NOTE: If applicable, {@link CustomCircleNetworkImageView#setDefaultImageResId(int)} and
     * {@link CustomCircleNetworkImageView#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
    ...
    private void loadImageIfNecessary(final boolean isInLayoutPass) {
        ...
        boolean isFullyWrapContent = getLayoutParams() != null && getLayoutParams().height == ViewGroup.LayoutParams.WRAP_CONTENT && getLayoutParams().width == ViewGroup.LayoutParams.WRAP_CONTENT;
